...
const games = [
  ...
  { "icon": `games/2048/meta/apple-touch-icon.png`, "path": `games/2048/index.html`, "error": false, "name": "2048" },
  { "icon": `games/8-ball/IMG_2666.png`, "path": `games/8-ball/index.html`, "error": false, "name": "8 Ball Pool" },
  { "icon": `games/Among-Us/red.png`, "path": `games/Among-Us/index.html`, "error": false, "name": "Among Us" },
  { "icon": `games/AngrySharks/assets/favicon/icon-512x512.png`, "path": `games/AngrySharks/index.html`, "error": false, "name": "Angry Sharks" },
]
